...
func ConsumeQueue() {
	...
	go func() {
		for d := range msgs {
			...
			data.Prompt = "Por favor, analise os dados do lead a seguir, obtidos por buscas no Google e complementados pelas chaves 'TavilyData', 'SerperData' e 'CNPJData'. Extraia e identifique estritamente os seguintes dados:\n- Razão Social da empresa (RegisteredName)\n- CNPJ\n- Contatos: insira o(s) nome(s) do(s) responsável(is) pela empresa, concatenando-os em uma única string separada por vírgula\n- Data de Fundação\n- Website\n- Redes Sociais (Facebook, Instagram, TikTok, WhatsApp)\n\nInstruções adicionais:\n1. Retorne a resposta estritamente no formato JSON, sem comentários ou textos adicionais, exceto um bloco interno de raciocínio (entre <think> e </think>) contendo uma breve explicação do processo de extração dos dados.\n2. Não crie um campo separado para \"Responsavel\"; utilize apenas o campo \"Contatos\" para armazenar os nomes dos responsáveis.\n3. Se algum campo não estiver disponível, retorne null ou uma string vazia, conforme apropriado."
